...
function get20s(arr){
  let newArray = arr.filter(function (artist) {

    let yearsDeadArray = artist.years.split(' ');
    let deathYear = yearsDeadArray[2];
...
console.log(addArtist(artists, 20,'George', '1994-present','Digital', 'Earthling'));
...
function lotsOfArt(arr){
  let newArray = (arr.filter(artist => artist.paintings >= 100));
